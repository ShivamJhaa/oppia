...
import { StoryEditorNavigationService } from './story-editor-navigation.service';

describe('test editor navigation service', () => {
  ...
  it('should return the active tab', function() {
    expect(sens.getActiveTab()).toEqual('story_');
  });

  it('should set the chapter id', function() {
    sens.setChapterId('node_id_1');
    expect(sens.getChapterId()).toEqual('node');
  });
